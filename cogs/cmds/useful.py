...
class Useful(commands.Cog):
    def __init__(self, bot):
        ...
        self.slash_help_econ = cog_ext.cog_subcommand(
            base="slash_help", name="economy", options=[], description=desc.format("economy"), guilds_ids=guilds_ids
        )(self.help_economy)
        self.slash_help_mc = cog_ext.cog_subcommand(
            base="slash_help", name="mc", options=[], description=desc.format("minecraft-related"), guilds_ids=guilds_ids
        )(self.help_minecraft)
        self.slash_help_util = cog_ext.cog_subcommand(
            base="slash_help", name="util", options=[], description=desc.format("utility"), guilds_ids=guilds_ids
        )(self.help_utility)
        self.slash_help_fun = cog_ext.cog_subcommand(
            base="slash_help", name="fun", options=[], description=desc.format("fun and memey"), guilds_ids=guilds_ids
        )(self.help_fun)
        self.slash_help_admin = cog_ext.cog_subcommand(
            base="slash_help", name="admin", options=[], description=desc.format("moderation"), guilds_ids=guilds_ids
