...
class Econ(commands.Cog):
    ...
    async def shop_tools(self, ctx):
        ...
        await self.shop_logic(
            ctx, "tools", f"{ctx.l.econ.shop.villager_shop} [{ctx.l.econ.shop.tools.format(self.d.emojis.netherite_pickaxe)}]"
        )
    ...
    async def shop_magic(self, ctx):
        ...
        await self.shop_logic(
            ctx, "magic", f"{ctx.l.econ.shop.villager_shop} [{ctx.l.econ.shop.magic.format(self.d.emojis.enchanted_book)}]"
        )
    ...
    async def shop_other(self, ctx):
        ...
        await self.shop_logic(
            ctx, "other", f"{ctx.l.econ.shop.villager_shop} [{ctx.l.econ.shop.other.format(self.d.emojis.totem)}]"
        )
