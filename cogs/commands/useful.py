...
f'**{ctx.prefix}honey** *apparently bees produce honey, who knew it could sell for emeralds*\n',
    ...
    async def information(self, ctx):
        ...
        infoMsg.set_author(name="Villager Bot Information", url=discord.Embed.Empty, icon_url=str(self.bot.user.avatar_url_as(static_format="png")))
    ...
    async def do_math(self, ctx):
        ...
        if len(problem) > 500:
            ...
            return
        problem = problem.replace("÷", "/").replace("x", "*")
