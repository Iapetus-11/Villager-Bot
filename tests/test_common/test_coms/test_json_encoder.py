...
@pytest.mark.parametrize(
    ...
    [
        ...
        ((value := datetime.timedelta(days=1, seconds=1, microseconds=1, milliseconds=1, minutes=1, hours=1, weeks=1)), {"__timedelta_object": {"days": value.days, "seconds": value.seconds, "microseconds": value.microseconds}}),
    ]
)
